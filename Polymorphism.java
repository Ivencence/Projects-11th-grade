public class Polymorphism {
    public static void main(String[] args) {
        ...
        //Answer: I think that there will be a line for each animal in the order chicken, cow and pig that shows what sound they make and then a new line where it says their name and the product they give and between each there would be a blank line
    }
}
...
class Pig extends Animal{
    public Pig(int id, String name, int age, String gender){
        super(id, name,age, gender);
    }
    public void makeSound(){
        System.out.println(name + " the pig says: Honk!");
    }
